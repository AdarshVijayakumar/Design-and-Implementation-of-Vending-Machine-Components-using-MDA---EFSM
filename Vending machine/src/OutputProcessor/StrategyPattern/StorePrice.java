...
import DataStore.*;
                                    //This is an abstract class for the implementation of 2 versions StorePrice
public interface StorePrice {
    ...
    public void StorePrice();                 //This is an abstract function for the actual implementation of the function SrorePrice()
